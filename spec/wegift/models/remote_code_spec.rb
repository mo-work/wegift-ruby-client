...
RSpec.describe Wegift::RemoteCode do
  describe 'GET' do
    let(:url) { 'https://playground.plum.io/public/gifts/instant/c02bd09f-2c17-4bb6-ad5d-38f4143a01d0' }
    ...
    context 'when URL is valid but not known to plum' do
      let(:url) { 'https://playground.plum.io/public/gifts/instant/c02bd09f-0000-0000-0000-38f4143a01d1' }

      it 'is not successful' do
        VCR.use_cassette('get_remote_code_invalid_unknown_plum_url') do
          expect(remote_code.is_successful?).to be false
